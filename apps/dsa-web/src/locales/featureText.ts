...
export const ALERT_TRIGGER_HISTORY_TEXT = {
  zh: {
    ...
    emptyFilteredDescription: '当前筛选条件下没有触发历史，试试调整状态、规则或目标筛选。',
    subtitle: '{total} 条记录',
    status: '状态',
    rule: '规则',
    ruleTarget: '规则 / 目标',
    ruleIdFallback: '规则 #{id}',
    unknownRule: '未知规则',
    statusFilterAll: '全部状态',
    ruleFilterAll: '全部规则',
    targetFilterAll: '全部目标',
    sortAsc: '升序',
    sortDesc: '降序',
    sortByStatus: '按状态排序',
    sortByRule: '按规则名排序',
  ...
  en: {
    ...
    emptyFilteredDescription: 'No trigger history matches the current filters. Try changing status, rule, or target.',
    subtitle: '{total} records',
    status: 'Status',
    rule: 'Rule',
    ruleTarget: 'Rule / target',
    ruleIdFallback: 'Rule #{id}',
    unknownRule: 'Unknown rule',
    statusFilterAll: 'All statuses',
    ruleFilterAll: 'All rules',
    targetFilterAll: 'All targets',
    sortAsc: 'Ascending',
    sortDesc: 'Descending',
    sortByStatus: 'Sort by status',
    sortByRule: 'Sort by rule name',
